...
export default function PlaceGallery({ place }) {  // Change from placeData to place
                ...
                <div className="grid">
                    {place.photos?.[1] && (
                        <img 
                            onClick={() => setShowAllPhotos(true)}
                            className="aspect-square cursor-pointer object-cover" 
                            src={`${process.env.PUBLIC_URL}${place.photos[1]}`} 
                    ...
                    <div className="overflow-hidden">
                        {place.photos?.[2] && (
                            <img 
                                ...
                                src={`${process.env.PUBLIC_URL}${place.photos[2]}`} 
